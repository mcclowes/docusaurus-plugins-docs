...
| [**Share selection**](./share-selection/overview.md)                                               | Highlight text to copy it for Slack or Teams, ask an AI with page context, or share it, with deep links to the exact passage. |
