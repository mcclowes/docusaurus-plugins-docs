...
| [`docusaurus-plugin-speccy`](https://www.npmjs.com/package/docusaurus-plugin-speccy)                 | [Speccy docs](https://github.com/mcclowes/speccy/blob/main/apps/docusaurus-demo/docs/docusaurus.md) |
